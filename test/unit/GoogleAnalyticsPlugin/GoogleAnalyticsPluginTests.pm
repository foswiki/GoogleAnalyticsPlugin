...
sub test_tracking_enabled_webs_all {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Enable}{Webs} = ' * ';
	my $web = 'Main';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Enable', 'Webs', $web );
...
sub test_tracking_enabled_webs_named {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Enable}{Webs} = ' Main, ';
	my $web = 'Main';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Enable', 'Webs', $web );
	$this->assert_equals( 1, $enabled );
}
...
sub test_tracking_enabled_webs_named_other {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Enable}{Webs} = ' Sandbox, ';
	my $web = 'Main';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Enable', 'Webs', $web );
	$this->assert_equals( 0, $enabled );
}
...
sub test_tracking_disabled_webs_all {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Disable}{Webs} = ' * ';
	my $web = 'Main';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Disable', 'Webs', $web );
	$this->assert_equals( 0, $enabled );
}
...
sub test_tracking_disabled_webs_named {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Disable}{Webs} = ',Main';
	my $web = 'Main';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Disable', 'Webs', $web );
	$this->assert_equals( 0, $enabled );
}
...
sub test_tracking_disabled_webs_named_other {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Disable}{Webs} = ',Sandbox,';
	my $web = 'Main';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Disable', 'Webs', $web );
	$this->assert_equals( 1, $enabled );
}
...
sub test_tracking_enabled_users_all {
	...
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Enable', 'Users', $userWikiName );
	$this->assert_equals( 1, $enabled );
}
...
sub test_tracking_enabled_users_named {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Enable}{Users} = " $userWikiName ";
	my $user = $this->{test_user};
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Enable', 'Users', $userWikiName );
	$this->assert_equals( 1, $enabled );
}
...
sub test_tracking_enabled_users_named_other {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Enable}{Users} = ' admin';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Enable', 'Users', $userWikiName );
	$this->assert_equals( 0, $enabled );
}
...
sub test_tracking_disabled_users_all {
	...
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Disable', 'Users', $userWikiName );
	$this->assert_equals( 0, $enabled );
}
...
sub test_tracking_disabled_users_named {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Disable}{Users} = " $userWikiName ";
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Disable', 'Users', $userWikiName );
	$this->assert_equals( 0, $enabled );
}
...
sub test_tracking_disabled_users_named_other {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Disable}{Users} = ' admin';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Disable', 'Users', $userWikiName );
	$this->assert_equals( 1, $enabled );
}
...
sub test_tracking_enabled_scripts_all {
	...
	my $script = 'Manage';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Enable', 'Scripts', $script );
	$this->assert_equals( 1, $enabled );
}
...
sub test_tracking_enabled_scripts_named {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Enable}{Scripts} = ' manage, ';
	my $script = 'manage';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Enable', 'Scripts', $script );
	$this->assert_equals( 1, $enabled );
}
...
sub test_tracking_enabled_scripts_named_other {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Enable}{Scripts} = ' view,edit,create, ';
	my $script = 'manage';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Enable', 'Scripts', $script );
	$this->assert_equals( 0, $enabled );
}
...
sub test_tracking_disabled_scripts_all {
	...
	my $script = 'Manage';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Disable', 'Scripts', $script );
	$this->assert_equals( 0, $enabled );
}
...
sub test_tracking_disabled_scripts_named {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Disable}{Scripts} = ' manage, ';
	my $script = 'manage';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Disable', 'Scripts', $script );
	$this->assert_equals( 0, $enabled );
}
...
sub test_tracking_disabled_scripts_named_other {
	...
	$Foswiki::cfg{Plugins}{GoogleAnalyticsPlugin}{Tracking}{Disable}{Scripts} = ' view,edit,create, ';
	my $script = 'manage';
	my $enabled = Foswiki::Plugins::GoogleAnalyticsPlugin::_isTrackingEnabledInSetting( 'Disable', 'Scripts', $script );
	$this->assert_equals( 1, $enabled );
}
